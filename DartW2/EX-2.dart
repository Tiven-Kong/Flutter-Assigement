class BankAccount {
  ...
  BankAccount(this.accountHolderName, this.accountNumber, this.accountID, this.balance, this.currency); 
...
class Bank {
  ...
  void createAccount(int accountId, String accountOwner) {
    ...
    var newAccount = BankAccount(accountOwner, "Account-$accountID", accountID, 0.0, "USD");

    // Add the new account to the accounts list
    accounts.add(newAccount);
    print("New account created: ${newAccount.accountHolderName} with ID: $accountID");
  }
}
